...
#define DE_INF(fmt, arg...)        hal_log_info(fmt, ##arg)
#define DE_MSG(fmt, arg...)        hal_log_info(fmt, ##arg)
#define DE_HERE 
#define DE_DBG(fmt, arg...)        hal_log_debug(fmt, ##arg)
...
#else
#define DE_INF(msg...)  do {} while (0)
#define DE_MSG(msg...)  do {} while (0)
#define DE_HERE         do {} while (0)
#define DE_DBG(msg...)  do {} while (0)
#endif

// #define DE_DEBUG_ENABLE
#ifdef DE_DEBUG_ENABLE
#define DE_WRN(fmt, arg...)    hal_log_warn(fmt, ##arg)
#define DE_DBG2(fmt, arg...)   hal_log_debug(fmt, ##arg)
#else
#define DE_WRN(fmt, arg...)    do {} while (0)
#define DE_DBG2(fmt, arg...)   do {} while (0)
#endif
...
struct disp_layer {
	...
	s32 (*check1)(struct disp_layer *layer,
		      struct disp_layer_config *config);
