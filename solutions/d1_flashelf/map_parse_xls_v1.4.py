...
def parse_library(sym_all_list, benchbook):
    ...
    #set table title
    worksheet.write_row(row, 0, ['MODULE', 'OWNER', 'TOTAL', 'TEXT', 'RODATA', 'DATA'], title_format)
    row += 1
    ...
    for lib_dic in lib_dic_list:
        ...
        worksheet.write_row(row, 0, [lib_dic['Lib'], lib_owner, lib_dic['RAM'], lib_dic['Text'], lib_dic['Rodata'], lib_dic['Data']], entry_format)
        row += 1
